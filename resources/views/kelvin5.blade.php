...
<head>
  ...
  <title>{{$a1->lead}}{{$a1->name}}儀器成績對照表</title>
...
<div class="container">
  ...
  <h4 >#{{$a1->lead}} {{$a1->name}} IA-日期:@if($a4) {{$a4->date1}} @else ---/--/-- @endif
  FU1-日期:@if($a7) {{$a7->date1}} @else ---/--/-- @endif   FU2-日期:@if($a10) {{$a10->date1}} @else ---/--/-- @endif<h4>
...
<div class="col col-md-4 col-sm-12">
  ...
  <li class="list-group-item"><h5> IA-未加心智</h5></li>
  ...
  <li class="list-group-item">  <h5>Fu1-未加心智</h5></li>
  ...
  <div class="col col-md-4 col-sm-12">
  <ul class="list-group">
    <li class="list-group-item"><h5>日期:@if($a10) {{$a10->date1}} @else ---/--/-- @endif</h5></li>
  <li class="list-group-item">  <h5>Fu2-未加心智</h5></li>
 
  <li class="list-group-item">  <img class="img-fluid kelvin5"  src="{{asset('storage/'.$a8->p2)}}"/></li>
  <li class="list-group-item">  <img class="img-fluid kelvin6"  src="{{asset('storage/'.$a8->p3)}}"/></li>
  <li class="list-group-item">  <img class="img-fluid kelvin7"  src="{{asset('storage/'.$a8->p4)}}"/></li>
</ul>
...
<div class="col col-md-4 col-sm-12">
  <ul class="list-group">
    <li class="list-group-item"><h5> 日期:@if($a4) {{$a4->date1}} @else ---/--/-- @endif</h5></li>
  <li class="list-group-item"><h5>IA 加入心智</h5></li>
  ...
  <ul class="list-group">
    <li class="list-group-item"><h5> 日期:@if($a7) {{$a7->date1}} @else ---/--/-- @endif</h5></li>
  <li class="list-group-item">  <h5>Fu1 加入心智</h5></li>
  ...
  <ul class="list-group">
    <li class="list-group-item"><h5>日期:@if($a10) {{$a10->date1}} @else ---/--/-- @endif</h5></li>
  <li class="list-group-item">  <h5>Fu2 加入心智</h5></li>
   <li class="list-group-item">  <img class="img-fluid kelvin5"  src="{{asset('storage/'.$a8->p22)}}"/></li>
  <li class="list-group-item">  <img class="img-fluid kelvin6"  src="{{asset('storage/'.$a8->p32)}}"/></li>
  <li class="list-group-item">  <img class="img-fluid kelvin7"  src="{{asset('storage/'.$a8->p42)}}"/></li> 
  </ul>
  </div>
...
@endif
  ...
  <tbody>
   ...
   @else <h3> 還沒建資料</h3>
    ...
    <tr>
      ...
      <td>FU2 跳視反視反應時間</td>
      <td >@if ($a10->s3<37) <span class="text-danger">{{$a10->s3}}  </span>@else {{$a10->s3}} @endif (次)</td>
      <td>{{$a10->s1}}(次)</td>
      <td>{{$a10->s2}} (次)</td>
      <td>42 (次)</td>
      <td>37 (次)@if ($a10->s3<37) <span class="text-danger">未達</span>@else <span class="text-success">達標<span> @endif</td>
   ...
   @else <h3> 還沒建資料</h3>
    ...
    @if($a3 && $a6 &&$a9)
     ...
     <img class="img-fluid col-md-12 col-sm-12 my-2 kelvin3"  src="{{asset('storage/'.$a6->sl)}}"/>
      <h4>Fu2</h4>
     <img class="img-fluid col-md-12 col-sm-12 my-2 kelvin3"  src="{{asset('storage/'.$a9->sl)}}"/>
    @endif
   </div>
 ...
 <div class="my-5">
  ...
  @endif
    ...
    <tr>
       <td>Fu1 跳視反應準確度</td>
      <td >@if ($a10->s6<37) <span class="text-danger">{{$a10->s6}}  </span>@else {{$a10->s6}} @endif</td>
      <td>{{$a10->s1}} (次)</td>
      <td> {{$a10->s4}} (次)</td>
      <td> {{$a10->s5}}(次)</td>
      <td>42 (次)</td>
      <td>37 (次)@if ($a10->s6<37) <span class="text-danger">未達</span>@else <span class="text-success">達標<span> @endif</td>
      </tr>
    @else<h3> 還沒建資料</h3>
  @endif
  </tbody>
...
<h4>Fu2</h4>
     <img class="img-fluid col-md-12 col-sm-12 my-2 kelvin4 "  src="{{asset('storage/'.$a9->sa)}}"/>
@endif
</div>
   ...
   <div class="my-2 p-2 col col-md-12 col-sm-12 " >
    ...
    <h5>Fu2</h5>
    <img class="img-fluid "  src="{{asset('storage/'.$a9->gc)}}"/>
   @endif
      </div>
</div>
<p style='page-break-after:always'></p> 
...
<div class="my-2 p-2 col col-md-12 col-sm-12 " >
    ...
    <h5>Fu2</h5>
    <img class="img-fluid "  src="{{asset('storage/'.$a9->gl)}}"/>
      @endif
      </div>
</div>
<p style='page-break-after:always'></p> 
...
<div class="my-2 p-2 col col-md-12 col-sm-12 " >
 ...
 @if($a3 && $a6 && $a9 )
    ...
    <h5>Fu2</h5>
    <img class="img-fluid "  src="{{asset('storage/'.$a9->gr)}}"/>
   @endif
      </div>
</div>
<p style='page-break-after:always'></p> 
   ...
   <h4>眼球追視Pursuit</h4>
    <h5>平滑追視Smooth pursuit</h5>
     ...
     <img class="img-fluid mb2"  src="{{asset('storage/'.$a6->sp)}}" />
      ...
      <h5>Fu2</h5>
     <img class="img-fluid mb2"  src="{{asset('storage/'.$a9->sp)}}" />
     @endif
        </div>
    </div>
...
<div class="my-2  col col-md-12 col-sm-12 ">
 <div class="my-4 kelvin2">
   <h4>眼球追視Pursuit</h4>
     ...
     <h5>Fu2</h5>
     <img class="img-fluid mb2"  src="{{asset('storage/'.$a9->tp)}}" />
      @endif
        </div>
    </div>
